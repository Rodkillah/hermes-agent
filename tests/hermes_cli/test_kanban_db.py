...
@pytest.mark.xfail(
    strict=True,
    reason=(
        "Contrat Iron Rod : un parent archived ne libere PAS ses descendants "
        "(verdict PROD_NO_GO du 2026-08-28). Ce test amont affirme l'inverse. "
        "strict=True : s'il repasse au vert, c'est que notre contrat a saute, "
        "et pytest le signale en echec. Notre version du contrat : "
        "tests/hermes_cli/test_kanban_parent_still_gates.py"
    ),
)
