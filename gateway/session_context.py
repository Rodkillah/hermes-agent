...
_SESSION_VARS = (
    ...
    _SESSION_PARENT_CHAT_ID, _SESSION_BOT_PROFILE,
...
def set_session_vars(
    ...
    bot_profile: str = "", session_history_delivery: str | None = None,
) -> list:
